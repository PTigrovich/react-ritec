        ...
        <div className={styles.background}>
            <div className={styles.contentWrapper}>
                <div className={styles.imageConteiner}>
                    <img className={styles.itemImage} src="/images/background.jpg" alt="основатель" />
                </div>
            ...
            <div className={styles.buttonsContainer}>
                <Button
                    ...
                    onClick={() => openFullscreenVideo('/videos/interview.mp4')} // Исправлен путь (убрана лишняя 's')
                />
                <Button text={'СМОТРЕТЬ ИНТЕРВЬЮ'} className={styles.mediaButton} onClick={() => openFullscreenVideo('/videos/interview.mp4')} />
            </div>
            {videoUrl && (
                <video
                    ref={videoRef}
